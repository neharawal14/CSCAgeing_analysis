void int_lumi_function(TString chamber){
...
//TString file_path  ="/cmsuf/data/store/user/t2/users/neha.rawal/CSCAgeing_newfiles/2017_again/final_files/2017/input_root_files/DUMMYFILENAME_2017_new_all_"+chamber+"_tree.root" ;
		TString file_path  = "/cmsuf/data/store/user/t2/users/neha.rawal/CSC_2017_data_RAW_RECO/nTuple_output/2017/2017F_delievered/DUMMYFILENAME_F"+chamber+"_tree.root" ;
  ...
  Double_t _instlumi;
	...
	TH1D *hist_instlumi = new TH1D("hist_instlumi","inst lumi ",30, 0,15000);
	 ...
	 c_instlumi->cd();
	 hist_instlumi->Draw();
	 c_instlumi->SaveAs("intlumi_plots_F_delievered/instlumi_"+chamber+".pdf");

	 c_intlumi->cd();
	 hist_intlumi->Draw();
	 c_intlumi->SaveAs("intlumi_plots_F_delievered/intlumi_"+chamber+".pdf");
